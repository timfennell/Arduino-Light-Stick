...
int BRIGHTNESS = 20;    //0-255.  Lower number saves battery life, higher number is screamingly bright
...
int SPEEDO = 2;         //The speed of the animation
...
uint8_t thisrot = .5;                                          // You can change how quickly the hue rotates for this wave. 0= color stays the same
uint8_t allsat = 255;                                         // I like 'em fully saturated with colour.
bool thisdir = 0;                                             // You can change direction.
int8_t thisspeed = 255;                                         // You can change the speed, and use negative values.
uint8_t allfreq = 4;                                         // You can change the frequency, thus overall width of bars.
int thisphase = 0;                                            // Phase change value gets calculated.
uint8_t thiscutoff = 192;                                     // You can change the cutoff value to display this wave. Lower value = longer wave.
int loopdelay = 4;                                           // You can change the delay. Also you can change the allspeed variable above. 
uint8_t bgclr = 1;                                            // A rotating background colour.
...
uint8_t myfade = 20;                                         // Starting brightness.
...
void loop() {
    switch (ledMode) {
       case 0: BRIGHTNESS = 10; Rainbow(); break;              //Rainbow -- Change STEPS and SPEED to modify
